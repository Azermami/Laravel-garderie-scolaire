                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                <h3 class="font-weight-bolder text-info text-gradient">Bienvenue chez Online</h3>
                            </div>
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <form role="form" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        <label>Role</label>
                                        <div>
                                            <input type="radio" id="parent" name="role" value="parent" checked>
                                            <label for="parent">Parent</label>
                                        </div>
                                        <div>
                                            <input type="radio" id="personnel" name="role" value="personnel">
                    ...
                    <div class="col-md-6">
                        <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                            <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/curved-images/garderie.jpg')"></div>
                        </div>
                    </div>
                </div>
            </div>
